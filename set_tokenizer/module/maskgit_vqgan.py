# --------------------------------------------------------
# MaskGiT Decoder Module
#
# Based on:
#   - MaskGiT (https://github.com/google-research/maskgit)
#   - OpenMuse (https://github.com/huggingface/open-muse/blob/main/muse/modeling_maskgit_vqgan.py)
#   - TiTok (https://github.com/bytedance/1d-tokenizer/blob/main/modeling/modules/maskgit_vqgan.py)
# --------------------------------------------------------
